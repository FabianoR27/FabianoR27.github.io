    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        links.forEach(function (link) {
            link.addEventListener('click', function (e) {
                ...
                var page = link.getAttribute('href'); // Obtém o valor do href (URL do arquivo)
                var contentDiv = document.getElementById('content'); // Seleciona a div de conteúdo

                // Verifica se o conteúdo já está carregado e limpa a div se necessário
                if (contentDiv.getAttribute('data-loaded') === page) {
                    contentDiv.innerHTML = ''; // Limpa o conteúdo
                    contentDiv.removeAttribute('data-loaded'); // Remove o atributo indicando que está carregado
                ...
                xhr.onload = function () {
                    if (xhr.status === 200) {
                        ...
                        contentDiv.setAttribute('data-loaded', page); // Marca qual conteúdo foi carregado
                    } else {
